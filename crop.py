...
class SplitBase:
    def __init__(self, basepath, outpath, label_type='2', code='utf-8', gap=100, subsize=1024,
                 thresh=0.7, choosebestpoint=True, ext='.jpg'):
        """
        ...
        :param label_type: 1: OBB; 2: HBB
        :param code: encodeing format of txt file
        :param gap: overlap between two patches
        :param subsize: subsize of patch
        :param thresh: the thresh determine whether to keep the instance if the instance is cut down
        ...
        if self.label_type == 1:
            self.labelpath = os.path.join(self.basepath, 'labelTxt1')
            self.outlabelpath = os.path.join(self.outpath, 'labelTxt1')
        else:
            self.labelpath = os.path.join(self.basepath, 'labelTxt2')
            self.outlabelpath = os.path.join(self.outpath, 'labelTxt2')
