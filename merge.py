"""
    ...
    detpath is the path for 15 result files, for the format, you can refer to
...
def py_cpu_nms_poly(dets, thresh):
    ...
    for i in range(len(dets)):
        tm_polygon = polyiou.VectorDouble([dets[i][0], dets[i][1], dets[i][2], dets[i][3],
    ...
    for fullname in filelist:
        ...
        with open(fullname, 'r') as f_in:
            ...
            for splitline in splitlines:
                ...
                pattern2 = re.compile(r'_([\d+\.]+)_\d+_')
